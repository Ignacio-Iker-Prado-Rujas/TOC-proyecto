...
\Item Creación de un juego paralelo independiente que solo consiste en coger monedas que aparecen aleatoriamen. Dada nuestra experiencia jugando, creemos que 
este minijuego  pordría llegar a arrasar a nivel mundial.
\end{itemize}
